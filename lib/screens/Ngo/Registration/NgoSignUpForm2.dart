...
class NgoSignUpForm2 extends StatefulWidget {
  ...
  @override
  NgoSignUpForm2State createState() => NgoSignUpForm2State();
}

class NgoSignUpForm2State extends State<NgoSignUpForm2> {
  File _image;
  ...
  void initState() {
    ...
    ngogender = widget.model.ngogender;
    ngoaddress = widget.model.ngoaddress;
    ngoexperience=widget.model.ngoexperience;
    /*setState(() {
    ...
    return MyWidgets.nextButton(
      ...
      fun: () {
        if (NgoSignUpForm2.countryModel == null ||
            NgoSignUpForm2.countryModel == "") {
          AppData.showInSnackBar(context, "Please select Country");
        } else if (NgoSignUpForm2.stateModel == null ||
            NgoSignUpForm2.stateModel == "") {
          AppData.showInSnackBar(context, "Please select State");
        } else if (NgoSignUpForm2.districtModel == null ||
            NgoSignUpForm2.districtModel == "") {
          AppData.showInSnackBar(context, "Please select District");
        }else if (NgoSignUpForm2.citymodel == null ||
            NgoSignUpForm2.citymodel == "") {
          ...
          pharmaSignupModel.experience =  ngoexperience;
          pharmaSignupModel.gender =  ngogender;
          pharmaSignupModel.address =  ngoaddress;
          // pharmaSignupModel.address = textEditingController[8].t Idext;
          pharmaSignupModel.countryid = NgoSignUpForm2.countryModel.key;
          pharmaSignupModel.stateid = NgoSignUpForm2.stateModel.key;
          pharmaSignupModel.districtid = NgoSignUpForm2.districtModel.key;
          pharmaSignupModel.cityid = NgoSignUpForm2.citymodel.key;
  ...
  validate() async {
    ...
    if (error[0] == true) {
    ...
    } else if (NgoSignUpForm2.genderModel == null || NgoSignUpForm2.genderModel == "") {
      AppData.showInSnackBar(
      ...
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (NgoSignUpForm2.blockModel == null) {
