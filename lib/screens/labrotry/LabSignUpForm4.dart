...
class LabSignUpForm4 extends StatefulWidget {
  ...
  @override
  LabSignUpForm4State createState() => LabSignUpForm4State();
}

class LabSignUpForm4State extends State<LabSignUpForm4> {
  File _image;
  ...
  validate() async {
    ...
    } else if (LabSignUpForm4.genderModel == null || LabSignUpForm4.genderModel == "") {
      AppData.showInSnackBar(
    ...
    } else if (LabSignUpForm4.districtModel == null) {
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (LabSignUpForm4.blockModel == null) {
