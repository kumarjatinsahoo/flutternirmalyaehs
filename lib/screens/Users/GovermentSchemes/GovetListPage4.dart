...
class GovetListPage4 extends StatefulWidget {
  MainModel model;
  static KeyvalueModel labModel = null;
  final bool isConfirmPage;
  static KeyvalueModel medicinModel = null;

  GovetListPage4({Key key, this.model, this.isConfirmPage}) : super(key: key);
...
class _AboutUs extends State<GovetListPage4> {
  void initState() {
    // TODO: implement initState
    super.initState();
    GovetListPage4.labModel = null;
    setState(() {});
  }
