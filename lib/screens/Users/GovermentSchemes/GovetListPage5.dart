...
class GovetListPage5 extends StatefulWidget {
  MainModel model;
  static KeyvalueModel labModel = null;
  final bool isConfirmPage;
  static KeyvalueModel medicinModel = null;

  GovetListPage5({Key key, this.model, this.isConfirmPage}) : super(key: key);
...
class _AboutUs extends State<GovetListPage5> {
  void initState() {
    // TODO: implement initState
    super.initState();
    GovetListPage5.labModel = null;
    setState(() {});
  }
