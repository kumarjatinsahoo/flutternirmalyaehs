...
class Organ4Page extends StatefulWidget {
  MainModel model;
  static KeyvalueModel labModel = null;
  final bool isConfirmPage;
  static KeyvalueModel medicinModel = null;

  Organ4Page({Key key, this.model, this.isConfirmPage}) : super(key: key);
...
class _AboutUs extends State<Organ4Page> {

  void initState() {
    // TODO: implement initState
    super.initState();
    Organ4Page.labModel = null;
    setState(() {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("What is the procedure for organ donation?",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22),),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(20.0),
                    child: Container(child: Text(AppData.organ4,style:TextStyle(color: Colors.black,fontSize: 16),textAlign: TextAlign.justify,),),
                  ), /*Padding(
