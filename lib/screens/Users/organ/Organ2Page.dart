...
class Organ2Page extends StatefulWidget {
  MainModel model;
  static KeyvalueModel labModel = null;
  final bool isConfirmPage;
  static KeyvalueModel medicinModel = null;

  Organ2Page({Key key, this.model, this.isConfirmPage}) : super(key: key);
...
class _AboutUs extends State<Organ2Page> {

  void initState() {
    // TODO: implement initState
    super.initState();
    Organ2Page.labModel = null;
    setState(() {
