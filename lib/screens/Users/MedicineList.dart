  ...
  Widget dialogaddnomination(BuildContext context) {
    ...
    return AlertDialog(
                  ...
                  child: SizedBox(
                    ...
                    child: DropDown.networkDropdownGetpartUser(
                      ...
                      setState(() {
                        ...
                        MedicineList.medicinModel = data;
                        textEditingController[0].text =MedicineList.medicinModel.code;
      ...
      actions: <Widget>[
        ...
        new FlatButton(
          onPressed: () {
            if (MedicineList.medicinModel == null || MedicineList.medicinModel == "") {
              ...
              item.medname = MedicineList.medicinModel.key;
