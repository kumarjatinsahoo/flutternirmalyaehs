...
class EmergencyRoom extends StatefulWidget {
  MainModel model;

  EmergencyRoom({Key key, this.model}) : super(key: key);

  @override
  _EmergencyRoomState createState() => _EmergencyRoomState();
}

class _EmergencyRoomState extends State<EmergencyRoom> {
