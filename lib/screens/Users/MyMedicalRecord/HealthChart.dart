...
class HealthChart extends StatefulWidget {
  ...
  const HealthChart({Key key, this.model}) : super(key: key);

  @override
  _HealthChart createState() => _HealthChart();
}

class _HealthChart extends State<HealthChart> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Builder(builder: (BuildContext context) {
       ...
       // http://192.168.43.248:8061/user/mobile-view-patient-health-chart?id=OTEyMTIxMTI2MzIwNzA3NQ==
      /*Container(
    height: height,
    child: InAppWebView(
