...
class DisitaTestPage extends StatefulWidget {
  final MainModel model;
  const DisitaTestPage({Key key,this.model}) : super(key: key);

  @override
  _DisitaTestPageState createState() => _DisitaTestPageState();
}

class _DisitaTestPageState extends State<DisitaTestPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     /* body:Container(
        ...
        child:WebView(initialUrl: "https://demo.ehealthsystem.com/user/mobile-organ-donation-pdf-download?id="+id,
