...
class DisitalPrescriptionPage extends StatefulWidget {
  final MainModel model;
  const DisitalPrescriptionPage({Key key,this.model}) : super(key: key);

  @override
  _DisitalPrescriptionPageState createState() => _DisitalPrescriptionPageState();
}

class _DisitalPrescriptionPageState extends State<DisitalPrescriptionPage> {
