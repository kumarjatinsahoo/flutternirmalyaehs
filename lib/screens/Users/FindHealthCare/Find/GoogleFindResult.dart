...
class GoogleFindResult extends StatefulWidget {
  MainModel model;
  static KeyvalueModel distancelistModel = null;

  GoogleFindResult({Key key, this.model}) : super(key: key);

  @override
  _GoogleFindResultState createState() => _GoogleFindResultState();
}

class _GoogleFindResultState extends State<GoogleFindResult> {
