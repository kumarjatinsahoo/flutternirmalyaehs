...
class MedicineDetailslist extends StatefulWidget {
  final MainModel model;

  const MedicineDetailslist({Key key, this.model}) : super(key: key);

  @override
  _MedicineDetailslistState createState() => _MedicineDetailslistState();
}
class _MedicineDetailslistState extends State<MedicineDetailslist> {
  ...
  bool isdata = false;
  cnfrmorder.MedicineDetailslistModel pharmacycnfrmModel;
  @override
  void initState() {
    super.initState();
        ...
        fun: (Map<String, dynamic> map) {
          setState(() {
            ...
            if (map[Const.CODE] == Const.SUCCESS) {
              ...
              if (i == 1) {
                pharmacycnfrmModel = cnfrmorder.MedicineDetailslistModel.fromJson(map);
