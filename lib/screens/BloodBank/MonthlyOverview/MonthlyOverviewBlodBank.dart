...
class MonthlyOverviewBloodBank extends StatefulWidget {
  MainModel model;
...
class _MonthlyOverview extends State<MonthlyOverviewBloodBank> {
  ...
  /*callApi() {
    widget.model.GETMETHODCALL_TOKEN(
        api: ApiFactory.GET_BLDBANK_MONTHOVERVIEW + loginResponse.body.user,
  ...
  callApi(String fromdate, String todate) {
    widget.model.GETMETHODCALL_TOKEN(
        api: ApiFactory.GET_BLDBANK_MONTHOVERVIEW +
