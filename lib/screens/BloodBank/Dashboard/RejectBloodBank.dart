...
class RejectBloodBank extends StatefulWidget {
  final MainModel model;

  const RejectBloodBank({Key key, this.model}) : super(key: key);

  @override
  _RejectBloodBankState createState() => _RejectBloodBankState();
}

class _RejectBloodBankState extends State<RejectBloodBank> {
                    ...
                    child: (bloodbanklistModel != null)
                        ? ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              ...
                              ambulanceappoint.Body body =
                                  bloodbanklistModel.body[i];
                              return Padding(
