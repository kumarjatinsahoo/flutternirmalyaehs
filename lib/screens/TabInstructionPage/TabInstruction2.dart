...
class TabInstruction2 extends StatefulWidget {
  ...
  @override
  TabInstruction2State createState() => TabInstruction2State();
}

class TabInstruction2State extends State<TabInstruction2> {
  File _image;
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Column(
                                        children: [
                                          Text("Do you usually have daliy at least 30 minutes of physical activity at work and/or "
  ...
  Widget nextButton() {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, "/tabinstruction3");
        validate();
      },
      child: Container(
        width: MediaQuery.of(context).size.width,
  ...
  validate() async {
    ...
    } else if (TabInstruction2.genderModel == null || TabInstruction2.genderModel == "") {
      AppData.showInSnackBar(
    ...
    } else if (TabInstruction2.districtModel == null) {
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (TabInstruction2.blockModel == null) {
