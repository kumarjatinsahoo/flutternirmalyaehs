...
class TabInstruction6 extends StatefulWidget {
  ...
  @override
  TabInstruction6State createState() => TabInstruction6State();
}

class TabInstruction6State extends State<TabInstruction6> {
  File _image;
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Column(
                                        children: [
                                          Text("Have you ever been found to have high blood glucose"
                                              "(eg in a health examination, during an illness)?",
  ...
  Widget nextButton() {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, "/tabinstruction7");
        validate();
      },
      child: Container(
        width: MediaQuery.of(context).size.width,
  ...
  validate() async {
    ...
    } else if (TabInstruction6.genderModel == null || TabInstruction6.genderModel == "") {
      AppData.showInSnackBar(
    ...
    } else if (TabInstruction6.districtModel == null) {
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (TabInstruction6.blockModel == null) {
