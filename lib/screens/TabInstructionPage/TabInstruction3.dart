...
class TabInstruction3 extends StatefulWidget {
  ...
  @override
  TabInstruction3State createState() => TabInstruction3State();
}

class TabInstruction3State extends State<TabInstruction3> {
  File _image;
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Column(
                                        children: [
                                          Text("Have any of the members of your immediate family or "
                                              " other relative been diagnosed with diabetes "
                                              "(type 1 or type 2)?",
  ...
  Widget nextButton() {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, "/tabinstruction4");
        validate();
      },
      child: Container(
        width: MediaQuery.of(context).size.width,
  ...
  validate() async {
    ...
    } else if (TabInstruction3.genderModel == null || TabInstruction3.genderModel == "") {
      AppData.showInSnackBar(
    ...
    } else if (TabInstruction3.districtModel == null) {
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (TabInstruction3.blockModel == null) {
