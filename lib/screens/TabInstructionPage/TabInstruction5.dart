...
class TabInstruction5 extends StatefulWidget {
  ...
  @override
  TabInstruction5State createState() => TabInstruction5State();
}

class TabInstruction5State extends State<TabInstruction5> {
  File _image;
  ...
  Widget nextButton() {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, "/tabinstruction6");
        validate();
      },
      child: Container(
        width: MediaQuery.of(context).size.width,
  ...
  validate() async {
    ...
    } else if (TabInstruction5.genderModel == null || TabInstruction5.genderModel == "") {
      AppData.showInSnackBar(
    ...
    } else if (TabInstruction5.districtModel == null) {
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (TabInstruction5.blockModel == null) {
