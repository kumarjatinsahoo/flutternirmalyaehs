...
class TabInstruction extends StatefulWidget {
  ...
  @override
  TabInstructionState createState() => TabInstructionState();
}

class TabInstructionState extends State<TabInstruction> {
  File _image;
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Column(
                                        children: [
                                          Text("Waist circumference measured below the ribs(usually at the level of the naval)",
  ...
  validate() async {
    ...
    } else if (TabInstruction.genderModel == null || TabInstruction.genderModel == "") {
      AppData.showInSnackBar(
    ...
    } else if (TabInstruction.districtModel == null) {
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (TabInstruction.blockModel == null) {
