...
class TabInstruction7 extends StatefulWidget {
  ...
  @override
  TabInstruction7State createState() => TabInstruction7State();
}

class TabInstruction7State extends State<TabInstruction7> {
  File _image;
  ...
  validate() async {
    ...
    } else if (TabInstruction7.genderModel == null || TabInstruction7.genderModel == "") {
      AppData.showInSnackBar(
    ...
    } else if (TabInstruction7.districtModel == null) {
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (TabInstruction7.blockModel == null) {
