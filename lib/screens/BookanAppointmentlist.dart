...
BookanAppointmentlist extends StatefulWidget {
   MainModel model;
                                                     ...
                                                     Expanded(
                                                      ...
                                                      Row(
                                                          children: [
                                                            ...
                                                            Expanded(
                                                              child:  Text('926,FCROAD,SHIVAJINAGAR,ADJUCENT TO TUKARAM PADUKA CHOWK' ,
                                                              overflow: TextOverflow.clip, style: TextStyle(),),)
                                                      ]),
                                                         ],
                                                       ),
                                                ...
                                                Row(
                                                     children: [
                                                       ...
                                                       Text('Book Appointment',
                                                         overflow: TextOverflow.clip, style: TextStyle(color: Colors.red),),
                                                     ]),
                                                 ]),
                                               )),
                                           ),
