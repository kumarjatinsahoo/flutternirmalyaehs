...
class SignUpFormState extends State<SignUpForm> {
  ...
  void initState() {
    super.initState();
    SignUpForm.districtModel = null;
    SignUpForm.blockModel = null;
    SignUpForm.genderModel = null;
    /*setState(() {
  ...
  validate() async {
    ...
    } else if (SignUpForm.genderModel == null || SignUpForm.genderModel == "") {
      AppData.showInSnackBar(
    ...
    } else if (SignUpForm.districtModel == null) {
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (SignUpForm.blockModel == null) {
