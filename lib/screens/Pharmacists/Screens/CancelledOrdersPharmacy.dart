...
class CancelledOrdersPharmacy extends StatefulWidget {
  final MainModel model;

  const CancelledOrdersPharmacy({Key key, this.model}) : super(key: key);

  @override
  _CancelledOrdersPharmacyState createState() => _CancelledOrdersPharmacyState();
}

class _CancelledOrdersPharmacyState extends State<CancelledOrdersPharmacy> {
