...
class ConfirmOrdersPharmacy extends StatefulWidget {
  final MainModel model;

  const ConfirmOrdersPharmacy({Key key, this.model}) : super(key: key);

  @override
  _ConfirmOrdersPharmacyState createState() => _ConfirmOrdersPharmacyState();
}

class _ConfirmOrdersPharmacyState extends State<ConfirmOrdersPharmacy> {
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: RaisedButton(
                                    onPressed: null,
                                    child: Text(MyLocalizations.of(context).text("ACCEPTED"),
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize: 16,
