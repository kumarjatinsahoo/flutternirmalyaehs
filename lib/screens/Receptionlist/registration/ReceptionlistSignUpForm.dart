...
class ReceptionlistSignUpForm extends StatefulWidget {
  ...
  @override
  ReceptionlistSignUpFormState createState() => ReceptionlistSignUpFormState();
}

class ReceptionlistSignUpFormState extends State<ReceptionlistSignUpForm> {
  File _image;
  ...
  void initState() {
    super.initState();
    ReceptionlistSignUpForm.districtModel = null;
    ReceptionlistSignUpForm.blockModel = null;
    ReceptionlistSignUpForm.genderModel = null;

    ReceptionlistSignUpForm.organizationModel = null;
    ReceptionlistSignUpForm.titleModel = null;
    /*setState(() {
                                  ...
                                  DropDown.networkDropdownGetpartUser(
                                      ...
                                      23.0,
                                        ...
                                        setState(() {
                                          ...
                                          ReceptionlistSignUpForm.organizationModel = data;
                                ...
                                child: SizedBox(
                                  ...
                                  DropDown.networkDropdownGetpartUser(
                                    ...
                                    setState(() {
                                      ...
                                      ReceptionlistSignUpForm.titleModel =
                                          data;
  ...
  Widget gender() {
    return DropDown.searchDropdowntyp("Gender", "genderPartner", genderList,
            (KeyvalueModel model) {
          ReceptionlistSignUpForm.genderModel = model;
        });
  }
  ...
  Widget nextButton1() {
    return MyWidgets.nextButton(
      ...
      fun: () {
        ...
        if (ReceptionlistSignUpForm.organizationModel == null || ReceptionlistSignUpForm.organizationModel == "") {
          AppData.showInSnackBar(context, "Please select Organization Name");
        }else if (ReceptionlistSignUpForm.titleModel == null || ReceptionlistSignUpForm.titleModel == "") {
        ...
        // }
          ...
          widget.model.organisationname = ReceptionlistSignUpForm.organizationModel.key;
          widget.model.title = ReceptionlistSignUpForm.titleModel.key;
          ...
          Navigator.pushNamed(context, "/receptionlistsignup1");
        }
      },
    );
  ...
  validate() async {
    ...
    } else if (ReceptionlistSignUpForm.genderModel == null || ReceptionlistSignUpForm.genderModel == "") {
      AppData.showInSnackBar(
