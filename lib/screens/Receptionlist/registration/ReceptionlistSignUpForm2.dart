...
class ReceptionlistSignupForm2 extends StatefulWidget {
  ...
  @override
  ReceptionlistSignupForm2State createState() => ReceptionlistSignupForm2State();
}

class ReceptionlistSignupForm2State extends State<ReceptionlistSignupForm2> {
  File _image;
  ...
  void initState() {
    super.initState();
    ReceptionlistSignupForm2.districtModel = null;
    ReceptionlistSignupForm2.countryModel = null;
    ReceptionlistSignupForm2.stateModel = null;
    ReceptionlistSignupForm2.cityModel = null;

    ReceptionlistSignupForm2.blockModel = null;
    ReceptionlistSignupForm2.genderModel = null;
                        ...
                        children: <Widget>[
                          ...
                          DropDown.networkDropdownGetpartUser(
                            ...
                            setState(() {
                              ...
                              ReceptionlistSignupForm2.countryModel = data;
                              ReceptionlistSignupForm2.stateModel = null;
                              ReceptionlistSignupForm2.districtModel = null;
                              ReceptionlistSignupForm2.cityModel = null;
                            });
                          ...
                          (ReceptionlistSignupForm2.countryModel != null)
                              ...
                              ApiFactory.STATE_API +
                                  (ReceptionlistSignupForm2?.countryModel?.key ??
                                      ""),
                              "stated",
                              Icons.location_on_rounded,
                              23.0, (KeyvalueModel data) {
                            setState(() {
                              ...
                              ReceptionlistSignupForm2.stateModel = data;
                              ReceptionlistSignupForm2.districtModel = null;
                              ReceptionlistSignupForm2.cityModel = null;
                            });
                          })
                          ...
                          (ReceptionlistSignupForm2.stateModel != null)
                              ...
                              ApiFactory.DISTRICT_API +
                                  (ReceptionlistSignupForm2?.stateModel?.key ??
                                      ""),
                              "districtd",
                              Icons.location_on_rounded,
                              23.0, (KeyvalueModel data) {
                            setState(() {
                              ...
                              ReceptionlistSignupForm2.districtModel = data;
                              ReceptionlistSignupForm2.cityModel = null;
                            });
                          })
                              : Container(),
                          (ReceptionlistSignupForm2.districtModel != null)
                              ...
                              ApiFactory.CITY_API +
                                  (ReceptionlistSignupForm2?.districtModel?.key ??
                                      ""),
                              "cityd",
                              Icons.location_on_rounded,
                              23.0, (KeyvalueModel data) {
                            setState(() {
                              ...
                              ReceptionlistSignupForm2.cityModel = data;
  ...
  Widget nextButton1() {
    return GestureDetector(
      onTap: () {
        if (textEditingController[8].text == "" ||
        ...
        } else if (ReceptionlistSignupForm2.countryModel == null ||
            ReceptionlistSignupForm2.countryModel == "") {
          AppData.showInSnackBar(context, "Please select Country");
        } else if (ReceptionlistSignupForm2.stateModel == null ||
            ReceptionlistSignupForm2.stateModel == "") {
          AppData.showInSnackBar(context, "Please select State");
        } else if (ReceptionlistSignupForm2.districtModel == null ||
            ReceptionlistSignupForm2.districtModel == "") {
          AppData.showInSnackBar(context, "Please select District");
        } else if (ReceptionlistSignupForm2.cityModel == null ||
            ReceptionlistSignupForm2.cityModel == "") {
          ...
          doctorModel.countryid = ReceptionlistSignupForm2.countryModel.key;
          doctorModel.stateid = ReceptionlistSignupForm2.stateModel.key;
          doctorModel.districtid = ReceptionlistSignupForm2.districtModel.key;
          doctorModel.cityid = ReceptionlistSignupForm2.cityModel.key;
  ...
  validate() async {
    ...
    if (error[0] == true) {
      ...
      FocusScope.of(context).requestFocus(fnode2);
    } else if (ReceptionlistSignupForm2.genderModel == null ||
        ReceptionlistSignupForm2.genderModel == "") {
      AppData.showInSnackBar(
      ...
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (ReceptionlistSignupForm2.blockModel == null) {
