...
class ReceptionlistSignUpFormm extends StatefulWidget {
  ...
  @override
  ReceptionlistSignUpFormmState createState() =>
      ReceptionlistSignUpFormmState();
}

enum TypeDob { Age, DOB }

class ReceptionlistSignUpFormmState extends State<ReceptionlistSignUpFormm> {
  File _image;
  ...
  void initState() {
    super.initState();
    ReceptionlistSignUpFormm.genderModel = null;
    ReceptionlistSignUpFormm.titleModel = null;
    ReceptionlistSignUpFormm.countryModel = null;
  ...
  Widget gender() {
    return DropDown.searchDropdowntyp("Gender", "genderPartner", genderList,
            (KeyvalueModel model) {
          ReceptionlistSignUpFormm.genderModel = model;
        });
  }
  ...
  validate() async {
    if (ReceptionlistSignUpFormm.organizationModel == null ||
      ...
      doctorModel.countryid = ReceptionlistSignUpFormm.countryModel.key;
      doctorModel.stateid = ReceptionlistSignUpFormm.stateModel.key;
      doctorModel.districtid = ReceptionlistSignUpFormm.districtModel.key;
      doctorModel.cityid = ReceptionlistSignUpFormm.cityModel.key;
