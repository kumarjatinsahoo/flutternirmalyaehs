...
class ReceptionlistSignupForm1 extends StatefulWidget {
  ...
  @override
  ReceptionlistSignupForm1State createState() => ReceptionlistSignupForm1State();
}

class ReceptionlistSignupForm1State extends State<ReceptionlistSignupForm1> {
  File _image;
  ...
  void initState() {
    ...
    ReceptionlistSignupForm1.districtModel = null;
    ReceptionlistSignupForm1.blockModel = null;

    ReceptionlistSignupForm1.genderModel = null;
    ReceptionlistSignupForm1.specialistModel = null;
    ReceptionlistSignupForm1.bloodgroupModel = null;
    /*setState(() {
                            ...
                            child: SizedBox(
                              ...
                              child: DropDown.networkDropdownGetpartUser(
                                ...
                                setState(() {
                                  ...
                                  ReceptionlistSignupForm1.specialistModel = data;
                            ...
                            child: SizedBox(
                              ...
                              child: DropDown.networkDropdownGetpartUser(
                                ...
                                setState(() {
                                  ...
                                  ReceptionlistSignupForm1.bloodgroupModel = data;
                                });
                              }),
                            ),
                          ),
                            ...
                            child: SizedBox(
                              ...
                              child: DropDown.networkDropdownGetpartUser(
                                ...
                                setState(() {
                                  ...
                                  ReceptionlistSignupForm1.genderModel = data;
  ...
  Widget nextButton1() {
    return MyWidgets.nextButton(
      ...
      fun: () {
        ...
        } /*else if (ReceptionlistSignupForm1.specialistModel == null ||
            ReceptionlistSignupForm1.specialistModel == "") {
        ...
        } else if (ReceptionlistSignupForm1.bloodgroupModel == null ||
            ReceptionlistSignupForm1.bloodgroupModel == "") {
          AppData.showInSnackBar(context, "Please select Blood Group");
        } else if (ReceptionlistSignupForm1.genderModel == null ||
            ReceptionlistSignupForm1.genderModel == "") {
          AppData.showInSnackBar(context, "Please select Gender");
        } else {
          widget.model.education = textEditingController[8].text;
         // widget.model.speciality = ReceptionlistSignupForm1.specialistModel.key;
          widget.model.dateofbirth = textEditingController[2].text;
          widget.model.bloodgroup = ReceptionlistSignupForm1.bloodgroupModel.key;
          widget.model.gender = ReceptionlistSignupForm1.genderModel.key;
          Navigator.pushNamed(context, "/receptionlistSignupform2");
        }
      },
    );
  }
  ...
  validate() async {
    ...
    } else if (ReceptionlistSignupForm1.districtModel == null) {
      AppData.showInSnackBar(context, "PLEASE SELECT DISTRICT");
    } else if (ReceptionlistSignupForm1.blockModel == null) {
