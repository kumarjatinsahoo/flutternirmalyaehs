...
class UserAppointmentTest extends StatefulWidget {
  MainModel model;
  ...
  @override
  _UserAppointmentTest createState() => _UserAppointmentTest();
}

class _UserAppointmentTest extends State<UserAppointmentTest> {
