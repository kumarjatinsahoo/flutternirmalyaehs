class AbhaResponseModel {
  ...
  Tags tags;
  bool newOne;
   AbhaResponseModel({this.token, this.refreshToken, this.healthIdNumber, this.name, this.gender, this.yearOfBirth, this.monthOfBirth, this.dayOfBirth, this.firstName, this.healthId, this.lastName, this.middleName, this.stateCode, this.districtCode, this.stateName, this.districtName, this.email, this.kycPhoto, this.profilePhoto, this.mobile, this.authMethods, this.pincode, this.tags, this.newOne});
